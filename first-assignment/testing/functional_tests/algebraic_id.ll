...
define i32 @test13(i32 noundef %0) #0 {
  %2 = lshr i32 %0, 1
  ret i32 %2
}

define i32 @test14(i32 noundef %0) #0 {
  %2 = ashr i32 %0, 1
  ret i32 %2
}

define i32 @test15(i32 noundef %0) #0 {
  %2 = add i32 0, %0
  ret i32 %2
}

define i32 @test16(i32 noundef %0) #0 {
  %2 = mul i32 1, %0
  ret i32 %2
}

define i32 @test17(i32 noundef %0) #0 {
  %2 = udiv i32 1, %0
  ret i32 %2
}

define i32 @test18(i32 noundef %0) #0 {
  %2 = sdiv i32 1, %0
  ret i32 %2
}

define i32 @test19(i32 noundef %0) #0 {
  %2 = shl i32 0, %0
  ret i32 %2
}

define i32 @test20(i32 noundef %0) #0 {
  %2 = lshr i32 0, %0
  ret i32 %2
}

define i32 @test21(i32 noundef %0) #0 {
  %2 = ashr i32 0, %0
  ret i32 %2
}
